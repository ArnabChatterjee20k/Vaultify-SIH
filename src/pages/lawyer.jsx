          ...
          <div className="flex flex-col lg:flex-col mb-20">
            ...
            <div className="flex flex-col lg:flex-row justify-between">
              <div className="flex flex-row">
                <button onClick={()=>nav("/upload")} className="p-3 text-xl w-60 lg:w-80 mt-4 lg:mt-10 flex items-center mr-2 bg-gradient-to-r from-pink-500 to-purple-800 hover:bg-gradient-to-r hover:from-pink-700 hover:to-purple-900 rounded-2xl justify-center focus:outline-none">
                  Upload Files
              ...
              <div className="flex">
                <button className="p-3 text-xl w-80 mt-4 lg:mt-10 flex items-center mr-4 bg-gradient-to-r from-pink-500 to-purple-800 hover:bg-gradient-to-r hover:from-pink-700 hover:to-purple-900 rounded-2xl justify-center focus:outline-none">
                  Show Case ID
                  <RiEyeFill className="ml-2" />
                </button>
                <button className="p-3 text-xl w-80 mt-4 lg:mt-10 flex items-center mr-2 bg-gradient-to-r from-pink-500 to-purple-800 hover:bg-gradient-to-r hover:from-pink-700 hover:to-purple-900 rounded-2xl justify-center focus:outline-none">
                  Share with CLIENT
                  <FaShareAlt className="ml-2" />
                </button>
              </div>
